...
(* OASIS_START *)
(* DO NOT EDIT (digest: f02c6d0e3ce19bccd11f6adb7c88efe5) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "utils";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "xapi-database"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "dbconvert.ml"});
               Executable
                 ({
                     cs_name = "test_suite";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "database_test_main.ml"
                   });
               Test
                 ({
                     cs_name = "test_suite";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\011O\221\198\157)\136\160\206]\163\237l~\246\017";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
